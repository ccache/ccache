...
TEST_CASE("test_known_strings")
{
...

  {
    ...
    hash_string(h, "a");
    CHECK(hash_result(h).to_string()
          == "17762fddd969a453925d65717ac3eea21320b66b54342fde15128d6c");
    hash_free(h);
  }

  {
    ...
    CHECK(hash_result(h).to_string()
          == "7bc2a2eeb95ddbf9b7ecf6adcb76b453091c58dc43955e1d9482b194");
    hash_free(h);
  }

  {
    ...
    hash_string(
      ...
      "1234567890");
    CHECK(hash_result(h).to_string()
          == "f263acf51621980b9c8de5da4a17d314984e05abe4a21cc83a07fe3e");
    hash_free(h);
  }
}
...
TEST_CASE("hash_result digest bytes")
{
  ...
  uint8_t expected[Digest::size()] = {
    ...
    0x43, 0x95, 0x5e, 0x1d, 0x94, 0x82, 0xb1, 0x94,
  };
