...
* Line numbers are relevant in some situations, such as for debug
  ...
  or <<config_sloppy_unify_with_output,*unify_with_output*>> sloppiness
  options.
...
That is, with <<config_sloppy_unify_with_output,*unify_with_output*>>
sloppiness option, this results in noisy compiler diagnostics.
Without <<config_sloppy_unify_with_output,*unify_with_output*>>, any
