...
Alternative: `+redis+unix://[[USERNAME:]PASSWORD@]SOCKET_PATH[?db=DBNUMBER[&password=PASSWORD]]+`
...
* `+redis+unix:/var/run/redis/redis-server.sock?password=p4ssw0rd&db=0|connect-timeout=50+`
