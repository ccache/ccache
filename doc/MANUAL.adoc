...
URL format: `redis://HOST:PORT` or `redis://UNIX_SOCK`
...
In addition to the in-memory database, there are also persistent NoSQL.
See <https://github.com/yinqiwen/ardb> (using https://rocksdb.org/[RocksDB] or similar)
