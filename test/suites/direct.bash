...
EOF
    ...
    # -------------------------------------------------------------------------
    TEST "Header search report in preprocessor stderr doesn't affect result key"

    CCACHE_NODIRECT=1 $CCACHE_COMPILE -c -Inonexistent_dir test.c
    expect_stat preprocessed_cache_hit 0
    expect_stat cache_miss 1

    $CCACHE_COMPILE -c -Inonexistent_dir test.c
    expect_stat direct_cache_hit 0
    expect_stat preprocessed_cache_hit 1
    expect_stat cache_miss 1
...
EOF
    backdate src/main.c include/foo.h other/bar.h

    $CCACHE_COMPILE -c -Iother -Iinclude src/main.c -o main.o
    ...
    cat <<EOF >include/bar.h
char x[] = "content_include";
EOF

    $CCACHE_COMPILE -c -Iother -Iinclude src/main.c -o main.o
    expect_contains main.o content_include
    expect_stat direct_cache_hit 1
    expect_stat cache_miss 2
